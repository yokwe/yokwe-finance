...
update-data-jp: update-jpx update-jita update-click-jp uupdate-nikko-jp update-rakuten-jp update-smtb-jp update-sony-jp
	make update-all
...
update-click-jp:
	ant click-update-trading-fund-jp

update-nikko-jp:
	ant nikko-update-trading-fund-jp
